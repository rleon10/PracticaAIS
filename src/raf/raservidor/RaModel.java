...
public class RaModel
{
    ...
    class ReceiveMessageThread extends Thread{
        ...
        public ReceiveMessageThread(RaModel b, Socket socket){
            this.socket = socket;
            this.raModel = b;
            System.out.println("Receive Messaje !!!!!!!!");
        }
        ...
        public void run(){
            ...
            try{
                ...
                System.out.println("Mensaje: " + message.kind + ", host: " + message.sender.host.toString());
     ...
     */
    public void startService (int portNo) throws IOException{
        port = portNo;
        try{
             raAddress = new RaAddress(InetAddress.getLocalHost(), port, null);
             System.out.println("Creado raAdress, voy a abrir puerto en " + port);
